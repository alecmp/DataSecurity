...
import alessandro.datasecurity.utils.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    public MessagesAdapter(Context mContext, List<MessageModel> messages, MessageAdapterListener listener) {
    ...
    private void applyProfilePicture(MyViewHolder holder, MessageModel message) {
    ...
    private void applyReadStatus(MyViewHolder holder, MessageModel message) {
        if (message.isRead()) {
